...
(function() {
  var answer, answerspan, calcpass, calcseed, crypt, cura, curq, data, editfunc, hover_in_func, hover_out_func, maindiv, minusfunc, plusfunc, qadiv, qas, qeditfunc, secretstr, selfunc, sendfile, showimage, timeout;
  ...
  selfunc = function(q, a) {
    return function() {
      ...
      (function() {
        _results = [];
        for (var _i = 0, _ref = qas[q]['answers'].length; 0 <= _ref ? _i < _ref : _i > _ref; 0 <= _ref ? _i++ : _i--){ _results.push(_i); }
        return _results;
  ...
  answerspan = function(q, a) {
    ...
    input = $('<input type="text" autocomplete="off" class="answer">').val(qas[q]['answers'][a]).attr('id', "answer" + q + "-" + a).css('background-color', a === 0 ? '#ccf' : '#fff').on('click', selfunc(q, a)).on('keyup', editfunc(q, a)).hover(hover_in_func(q, a), hover_out_func());
  ...
  qadiv = function(q) {
    var ansdiv, delim, div, img, minus, plus, qdiv, qinput, qstr, _i, _ref, _results;
    answer[q] = 0;
  ...
  maindiv = function() {
    var minus, plus, _i, _ref, _results;
    $("#main").children().remove();
    (function() {
      _results = [];
      for (var _i = 0, _ref = qas.length; 0 <= _ref ? _i < _ref : _i > _ref; 0 <= _ref ? _i++ : _i--){ _results.push(_i); }
      return _results;
    }).apply(this).forEach(function(i) {
