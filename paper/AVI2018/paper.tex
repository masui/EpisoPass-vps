...
\keywords{Passwords, visual passwords, user authentication, episodic memories, draw-a-secret}
...
\begin{figure}[H]
  \centerline{\includegraphics[width=13cm,bb=-250 -100 1272 1014]{figures/episopass.png}}
  \caption{EpisoPass}
  \label{EpisoPass}
\end{figure}
