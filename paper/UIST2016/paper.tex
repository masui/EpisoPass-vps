...
Here, ``\textsf{Twitter123456}'' is provided as the seed string,
and according to the selection to four questions,
the seed string is converted to strings like
``\textsf{Mfveabn574923}'', which can be used as the password for Twitter.
...
the password string generated after selecting all correct answers can be
...
and the last secret questionois related to a recent event which the author
thinks he can never forget.
