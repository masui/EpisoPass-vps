...
\marginnote{You mention that episodic memories and cognitive passwords have been used in the past, but it's not clear to me (from the text here) why your system is different. Perhaps you could put a sentence or two about this?}
...
\marginnote{Is the Android app generated as a unique app for each user? If so, I think it's worth making this clear.}
...
\marginnote{The fact that an `old' memory is unlikely to be forgotten is perhaps obvious, but this could be a good place
to cite a paper on memory/psychology about this if you're aware of any?}
...
\marginnote{In the comments you mention that ``generating service-specific unique seed string is not trivial''. I think this is worth mentioning in the paper.}
...
%
\marginnote{I calculate $20^{10} = 10,240,000,000,000$. This is considerably more than a billion (closer to 10 thousand billion, (US) or 10 million million (UK).}
%
