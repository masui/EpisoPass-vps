...
%
Figure \ref{extension} shows the login page of Amazon.com, where
EpisoPass questions are displayed by the browser extension.
%
In this case, when the Amazon login page is accessed from the browser,
the extension automatically runs on the page,
acquires questions and andwers from the EpisoPass server,
and shows them to the user just like the Android application.
%
After answering all the questions, a password is calculated from the
selected answers and pasted to the password textbox of the page.
Using the extension, users can login to various services
without seeing a password string;
It looks as if various services are offering
